...
export const DEBRIEF_CONFIGS: Record<string, ScenarioDebriefConfig> = {
  ...
  'medacademy-pathology-cells-going-wild': {
    keyHistoryQuestions: [
      ...
      'weight loss',
      'headache confusion coordination',
      'back pain bone pain',
      'family history cancer',
      'past medical history',
      'leg swelling',
      'fever',
      'chest pain shortness of breath timing',
    ],
    essentialInterviewQuestions: [
      'smoking history',
    ...
    optionalInterviewQuestions: ['cough', 'leg swelling', 'fever', 'physical exam'],
    keyExamItems: ['general', 'heent', 'neck', 'respiratory', 'cardiac', 'abdomen', 'extremities', 'neuro'],
    criticalTests: ['ct_angiogram_chest', 'lung_mass_biopsy', 'pet_scan', 'mri_brain'],
    essentialTests: ['ct_chest', 'ct_angiogram_chest', 'lung_mass_biopsy', 'ebus_lymph_node', 'pet_scan', 'mri_brain', 'bone_scan'],
    optionalTests: ['cbc', 'cmp', 'pft', 'cxr', 'sputum_cytology'],
    unnecessaryTests: ['d_dimer'],
    mustRecognizeFindings: [
    ...
    correctDiagnosisExplanation: [
      'Correct diagnosis: Primary lung cancer, likely non-small cell lung cancer, with concern for mediastinal lymph node involvement and possible metastatic disease.',
      'This patient has a heavy smoking history, a 3.1 cm right infrahilar lung mass, enlarged subcarinal lymph nodes, hoarseness, headaches, coordination/mentation changes, chronic back pain, and a recent hip fracture.',
      'These findings make lung cancer with possible spread a major concern. Pulmonary embolism was considered because of shortness of breath and chest pain, but it was ruled out by CT.',
      'The next key steps are tissue biopsy and staging with PET scan, brain MRI, and possible lymph node sampling.',
    ],
    differentialComparison: [
      {
        diagnosis: 'Pulmonary embolism',
        whyLessLikely: 'Initial concern for dyspnea and chest pain, but CT angiography ruled out PE.',
      },
      {
        diagnosis: 'Pneumonia',
        whyLessLikely: 'No fever, lungs clear on exam, and CT shows a mass rather than consolidation.',
      },
      {
        diagnosis: 'Benign lung mass',
        whyLessLikely: 'Heavy smoking, mediastinal nodes, and systemic symptoms favor malignancy.',
      },
    ],
    clinicalPearls: [
      ...
      'Hoarseness may reflect recurrent laryngeal nerve or mediastinal involvement.',
      'Neurologic symptoms warrant brain MRI to evaluate possible metastasis.',
      'Biopsy is required before final histologic classification.',
    ],
    vocabTerms: ['infrahilar mass', 'subcarinal lymph nodes', 'PET scan', 'EBUS', 'pack-years', 'staging'],
    correctDiagnosis:
    ...
    keyEvidence: [
      ...
      '1.2 cm subcarinal nodes',
      'PE ruled out',
      'Hoarseness, headache, coordination changes',
    ],
    idealReasoning:
